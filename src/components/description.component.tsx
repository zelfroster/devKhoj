...
export default function Description({
  ...
  userData: UserDataObjType;
}) {
  return (
    <section
      className='flex animate-slideDown flex-col justify-between gap-10 
      rounded-lg border-[1px] border-white/10 bg-lightPurple p-6 text-white/80
      md:p-10'
    >
      <div
      ...
      >
        ...
        {(userData.location || userData.company) && (
          <div
            className='flex h-max flex-col items-start gap-2 rounded-md 
            bg-[#ffffff06] py-3 pl-4 pr-2 md:items-end md:py-2'
          >
            {userData.location && (
              <div
                className='flex w-max flex-row-reverse items-center gap-1 
                md:flex-row'
              >
