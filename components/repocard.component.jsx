...
const RepoCard = ({ repoData }) => {
  return (
    <div className='flex flex-col justify-between gap-3 bg-[#111122] pl-6 pr-8 py-4 rounded-md border-[1px] border-white/10 hover:border-pink-400/60 duration-200'>
